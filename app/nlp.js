...
function responseHandler(nlp_entities, message, user) {
    ...
    if (nlp_entities.errors) {
        ...
        if ((intent.length > 0) && (intent[0].confidence >= confidence_threshold)) {
            ...
            else if ((intent[0].name == "name")) {
                return responses.preston_details.name;
            }

            else if ((intent[0].name == "culture")) {
                return responses.preston_details.ethnicity;
            }

            else if ((intent[0].name == "dob")) {
                return responses.preston_details.birthday;
            }
